...
class QuotaApi
{
    ...
    /**
     * @return \Hostinger\Model\V1QuotaResource
     *
     * @throws ApiException
     * @throws GuzzleException
     * @throws ExceptionInterface
     */
    public function getQuota(string $mailboxResourceId)
    {
        $request = new Request(
            method: 'GET',
            uri: $this->buildResourcePath('/api/v1/mailboxes/{mailboxResourceId}/quota', [
        ...
        return $this->serializer->deserialize($response->getBody()->getContents(), '\Hostinger\Model\V1QuotaResource', JsonEncoder::FORMAT);
    }
