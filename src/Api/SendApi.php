...
class SendApi
{
     ...
     */
    public function sendEmail(string $mailboxResourceId, ?\Hostinger\Model\V1SendRequest $v1SendRequest)
    {
        $request = new Request(
            method: 'POST',
            uri: $this->buildResourcePath('/api/v1/mailboxes/{mailboxResourceId}/send', [
                'mailboxResourceId' => $mailboxResourceId
            ]),
            headers: $this->getHeaders(),
            body: $this->serializer->serialize($v1SendRequest, JsonEncoder::FORMAT),
        );
